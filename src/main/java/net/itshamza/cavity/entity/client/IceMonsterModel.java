...
public class IceMonsterModel<T extends IceMonsterEntity> extends HierarchicalModel<T> {
	private final ModelPart all;
	private final ModelPart body;
	private final ModelPart head;

	public IceMonsterModel(ModelPart root) {
	...
	@Override
	public void setupAnim(IceMonsterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(IceMonsterEntity pEntity, float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
