...
public class SpiderMonsterModel<T extends SpiderMonsterEntity> extends HierarchicalModel<T> {
	private final ModelPart all;
	private final ModelPart body;
	private final ModelPart head;

	public SpiderMonsterModel(ModelPart root) {
	...
	@Override
	public void setupAnim(SpiderMonsterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(SpiderMonsterEntity pEntity, float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
