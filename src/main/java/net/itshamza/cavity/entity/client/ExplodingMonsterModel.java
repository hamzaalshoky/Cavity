...
public class ExplodingMonsterModel<T extends ExplodingMonsterEntity> extends HierarchicalModel<T> {
	private final ModelPart all;
	private final ModelPart body;
	private final ModelPart head;

	public ExplodingMonsterModel(ModelPart root) {
	...
	@Override
	public void setupAnim(ExplodingMonsterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
