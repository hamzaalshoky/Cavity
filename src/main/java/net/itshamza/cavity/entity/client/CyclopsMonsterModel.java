...
public class CyclopsMonsterModel<T extends CyclopsMonsterEntity> extends HierarchicalModel<T> {
	private final ModelPart all;
	private final ModelPart body;
	private final ModelPart head;

	public CyclopsMonsterModel(ModelPart root) {
	...
	@Override
	public void setupAnim(CyclopsMonsterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
