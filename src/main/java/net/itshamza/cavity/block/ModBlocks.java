...
import net.itshamza.cavity.block.custom.FilledCavityBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FLESH_BLOCK = registerBlock("flesh_block",
            () -> new RotatingBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS)));
    ...
    public static final RegistryObject<Block> CHEST_CAVITY = registerBlock("chest_cavity",
            () -> new CavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.ITEM_FRAME.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_BLAZE_CAVITY = registerBlock("unsewn_blaze_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.BLAZE_POWDER.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_GUNPOWDER_CAVITY = registerBlock("unsewn_gunpowder_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.GUNPOWDER.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_ENDER_EYE_CAVITY = registerBlock("unsewn_ender_eye_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.ENDER_EYE.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_BUNDLE_CAVITY = registerBlock("unsewn_bundle_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.BUNDLE.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_COPPER_CAVITY = registerBlock("unsewn_copper_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.COPPER_INGOT.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_ROTTEN_FLESH_CAVITY = registerBlock("unsewn_rotten_flesh_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.ROTTEN_FLESH.getDefaultInstance()));
    ...
    public static final RegistryObject<Block> UNSEWN_RIDABLE_CAVITY = registerBlock("unsewn_ridable_cavity",
            () -> new FilledCavityBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.ZOMBIE).mapColor(MapColor.COLOR_GREEN).strength(1F).sound(ModSounds.FLESH_BLOCK_SOUNDS), Items.SADDLE.getDefaultInstance()));
